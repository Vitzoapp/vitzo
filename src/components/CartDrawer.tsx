              ...
              <div className="border-t border-gray-100 bg-gray-50 px-6 py-6">
                ...
                <div className="mt-6">
                  <button
                    ...
                    className="flex w-full items-center justify-center rounded-2xl bg-slate-900 py-4 text-base font-bold text-white transition-all hover:bg-slate-800 hover:shadow-xl active:scale-[0.98]"
                  >
                    Checkout
                  </button>
                </div>
